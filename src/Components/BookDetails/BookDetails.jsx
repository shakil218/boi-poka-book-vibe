    ...
    <div className="hero min-h-screen">
      <div className="hero-content flex-col lg:flex-row">
        ...
        <div className="ml-14">
          ...
          <h6 className="text-[16px] font-medium text-gray-500 my-3">{category}</h6>
          <div className="border-t-1 border-dashed border-gray-400 "></div>
          <p className="my-3">
            ...
            <table className="table-xs mb-3">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="text-[16px] font-semibold">{yearOfPublishing}</td>
                </tr>
                {/* row 4 */}
                <tr>
                  <td>Rating:</td>
          ...
          <div>
          <button className="btn btn-outline border-gray-400 rounded-lg mr-5">Get Started</button>
          <button className="btn bg-[#50B1C9] text-white rounded-lg">Get Started</button>
          </div>
        </div>
      </div>
    </div>
